...
## *NOTE*: for some reason the upper plot (weekend) does not appear, running the code normally gives both figures though. The figure is attached to the Github repo.
